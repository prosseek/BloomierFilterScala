...
// This is simple test for checking if it works or not
object ExperimentSimple extends App {
  ...
  m = Map[String,Any]("Altitude" -> -47.7370279)
  b = new BloomierFilter(keysDict = m, m = 20, k = 3, q = 8*11, enc = new SimpleEncoder(), dec = new SimpleDecoder())
  println(b.get("Name"))
  println(b.get("Latitude"))
  println(b.get("Altitude"))
  println(b.getSize())
